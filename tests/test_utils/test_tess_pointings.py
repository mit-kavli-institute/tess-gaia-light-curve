"""
Tests for the tglc.util.tess_pointing module, which should provide spacecraft and camera
...
def test_pointing_data_exists():
    ...
    assert (data_files / "Year1-7_pointings_long.csv").is_file()
